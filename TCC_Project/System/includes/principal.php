            ...
            <div class="row">
                <div class="col-3 bg-light">
                        ...
                        <hr><div class="tags_main">&nbsp;<h3>Data:&nbsp;&nbsp;&nbsp;&nbsp;</h3><select name="data" class="forms border w-75 bg-white" name="menu_seletor" id="select_main" onchange="this.form.submit()" required>
                            ...
                            <option value="4" <?php echo ($dataFilter == 4) ? 'selected' : null?>>Fora de Prazo</option>
                        </select></div><hr>
                    </form>
                ...
                <?php foreach($Events as $Event) {
                    $dataInicio = new DateTime($Event->getDataHora_Inicio());
                    $outOfDate = ($dataFilter != 4 && $Event->getDataHora_Inicio() < date('Y-m-d h:i')) ? true : false; ?>
